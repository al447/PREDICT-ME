...
const RELAYER_CONFIG = {
  ...
  ALLOWED_METHODS: [
    ...
    'fillOrder',         // CTF Exchange order fill (operator)
    'matchOrders',       // CTF Exchange batch match (operator)
    'matchOrdersSimple', // CTF Exchange simple batch match (operator)
  ],
...
function getMethodParamTypes(method) {
  const types = {
    ...
    // CTF Exchange order methods — operator-level calls
    fillOrder:        ['tuple(uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,address,address,bytes,bytes32,bytes)', 'uint256'],
    matchOrders:      ['tuple(uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,address,address,bytes,bytes32,bytes)[]', 'tuple(uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,address,address,bytes,bytes32,bytes)'],
    matchOrdersSimple:['bytes32[]', 'bytes32'],
    // NegRisk param shapes
    split:            ['bytes32', 'uint256'],
    merge:            ['bytes32', 'uint256'],
