...
import { LayoutDashboard, BarChart3, Users, ScrollText, LogOut, Crown, Settings, ChevronRight, Gift, ArrowDownToLine, Menu, X, Database } from 'lucide-react';
...
const NAV = [
  ...
  { to: '/admin/markets/migrate', label: 'On-Chain Migration', icon: Database },
...
const PAGE_TITLES = {
  ...
  '/admin/markets/migrate': 'On-Chain Migration',
  '/admin/users': 'Users',
      ...
      <aside className="hidden lg:flex w-60 min-h-screen bg-[var(--color-surface)] border-r border-[var(--color-border)] flex-col fixed left-0 top-0 z-40">
        ...
        <div className="p-5 border-b border-[var(--color-border)]">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-bold text-[var(--color-gold)]">PredictMe</p>
