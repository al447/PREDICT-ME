...
export const marketsAPI = {
  ...
  getCryptoPriceHistory: (slug, days = 30) => api.get(`/markets/${slug}/crypto-price-history`, { params: { days } }),
};
...
export const depositAPI = {
  ...
  moonpaySign: (data) => api.post('/deposits/moonpay/sign', data),
  moonpaySimulatePayment: (data) => api.post('/deposits/moonpay/simulate-payment', data),
  // Exchange Connect (Fun.xyz CEX flow)
  createExchangeSession: (data) => api.post('/deposits/exchange/session', data),
  getExchangeSession: (id) => api.get(`/deposits/exchange/session/${id}`),
