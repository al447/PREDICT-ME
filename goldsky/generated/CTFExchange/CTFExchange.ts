...
export class CTFExchange__getOrderStatusResultValue0Struct extends ethereum.Tuple {
...
export class CTFExchange__hashOrderInputOrderStruct extends ethereum.Tuple {
  get salt(): BigInt {
...
export class CTFExchange__orderStatusResult {
  value0: boolean;
  value1: BigInt;
...
export class CTFExchange__registryResult {
  value0: BigInt;
  value1: Bytes;
...
export class CTFExchange extends ethereum.SmartContract {
  ...
  getOrderStatus(
    orderHash: Bytes,
  ): CTFExchange__getOrderStatusResultValue0Struct {
    let result = super.call(
      "getOrderStatus",
    ...
    return changetype<CTFExchange__getOrderStatusResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getOrderStatus(
    orderHash: Bytes,
  ): ethereum.CallResult<CTFExchange__getOrderStatusResultValue0Struct> {
    let result = super.tryCall(
      "getOrderStatus",
      "getOrderStatus(bytes32):((bool,uint256))",
      [ethereum.Value.fromFixedBytes(orderHash)],
    ...
    return ethereum.CallResult.fromValue(
      changetype<CTFExchange__getOrderStatusResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  hashOrder(order: CTFExchange__hashOrderInputOrderStruct): Bytes {
    let result = super.call(
      "hashOrder",
  ...
  try_hashOrder(
    order: CTFExchange__hashOrderInputOrderStruct,
  ...
  orderStatus(param0: Bytes): CTFExchange__orderStatusResult {
    let result = super.call(
      "orderStatus",
    ...
    return new CTFExchange__orderStatusResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
    );
  }
  ...
  try_orderStatus(
    param0: Bytes,
  ): ethereum.CallResult<CTFExchange__orderStatusResult> {
    let result = super.tryCall(
      "orderStatus",
      "orderStatus(bytes32):(bool,uint256)",
      [ethereum.Value.fromFixedBytes(param0)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new CTFExchange__orderStatusResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
      ),
    );
  ...
  registry(param0: BigInt): CTFExchange__registryResult {
    let result = super.call("registry", "registry(uint256):(uint256,bytes32)", [
      ethereum.Value.fromUnsignedBigInt(param0),
    ]);

    return new CTFExchange__registryResult(
      result[0].toBigInt(),
      result[1].toBytes(),
    );
  }
  ...
  try_registry(
    param0: BigInt,
  ): ethereum.CallResult<CTFExchange__registryResult> {
    let result = super.tryCall(
      "registry",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new CTFExchange__registryResult(value[0].toBigInt(), value[1].toBytes()),
    );
  }
